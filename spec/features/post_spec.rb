...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope that only post creators can see their posts' do
      ...
      post_from_other_user = Post.create(date: Date.today, work_performed: 'This post should not be seen', user_id: other_user.id)
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, work_performed: 'Rationale delete', user_id: delete_user.id, daily_hours: 3.0)
